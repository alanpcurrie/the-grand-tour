...
.intro-text {
  color: var(--color-space-suit-orange);
...
.arrow-label-text {
  ...
  width: 12rem;
  height: 2.5rem;
  background-color: var(--color-space-suit-orange);
  color: var(--color-solar-sand);
  ...
  &--oval {
    ...
    max-height: 80px;
    border-radius: 50%;
    background-color: var(--color-vader-black);
    color: var(--color-dune-blue);
  }
}
